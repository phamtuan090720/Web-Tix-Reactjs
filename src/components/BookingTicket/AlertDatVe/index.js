...
export default function AlertDialog(isOpen=false,mess="",isErr=false,handleClose,handleOpenBill) {
            ...
            <div>
                ...
                >
                    <Grid container style={{alignItems:"center",color:"#f50057"}}   >
                        ...
                        <Grid item xs={9}>
                            <DialogContent>
                                <DialogContentText style={{color:"#f50057"}} id="alert-dialog-description">{mess}</DialogContentText>
                            </DialogContent>
                        </Grid>
                    </Grid>
                </Dialog>
